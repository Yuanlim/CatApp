...
import { CatContextType } from "../types/contextType";

type Props = { children: React.ReactNode };
export const CatContext = createContext<CatContextType | undefined>(undefined);

export const CatDataProvider = ({ children }: Props) => {
    ...
    const [isStarted, setIsStarted] = useState<boolean>(false); // for after user input, swipe app started
    ...
    }, [isInitializingRef.current, isStarted])
